...
{
  // 0..6 - Analog Pins
  { PORTB,  7, PIO_ANALOG, (PIN_ATTR_ANALOG|PIN_ATTR_PWM_E), ADC_Channe9, NOT_ON_TIMER, EXTERNAL_INT_7 },
  { PORTB,  8, PIO_ANALOG, (PIN_ATTR_ANALOG|PIN_ATTR_PWM_E), ADC_Channe0,  TC4_CH0, TC4_CH0, EXTERNAL_INT_8 },
  ...
  // 17..18 - Gates
  { PORTA, 8, PIO_SERCOM, , No_ADC_Channel, , NOT_ON_TIMER,  }, // Gate 0
  { PORTA, 9, PIO_SERCOM, , No_ADC_Channel, , NOT_ON_TIMER,  }, // Gate 1
